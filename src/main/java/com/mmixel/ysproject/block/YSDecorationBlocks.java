...
public class YSDecorationBlocks {
    ...
    public static final RegistryObject<Block> KETTLE = BlockRegistry.registerBlock("kettle",
            ()->new KettleBlock(BlockBehaviour.Properties.of(Material.METAL).noCollission().sound(SoundType.COPPER)), YSTab.YS_DECORATION);
    //储物柜
    public static final RegistryObject<Block> LOCKER = BlockRegistry.registerBlockWithoutBlockItem("locker",
            ()->new LockerBlock(BlockBehaviour.Properties.of(Material.METAL).noOcclusion().sound(SoundType.COPPER)));
    //储物柜物品
    public static final RegistryObject<Item> LOCKER_ITEM = ItemRegistry.registerItem("locker_item",
            ()->new LockerBlockItem(LOCKER.get(), new Item.Properties().tab(YSTab.YS_DECORATION)));
    //衣柜_可藏人
    public static final RegistryObject<Block> CLOSET = BlockRegistry.registerBlockWithoutBlockItem("closet",
            ()->new ClosetBlock(BlockBehaviour.Properties.of(Material.METAL).noCollission().sound(SoundType.COPPER)));
    //衣柜_可藏人_物品
    public static final RegistryObject<Item> CLOSET_ITEM = ItemRegistry.registerItem("closet_item",
